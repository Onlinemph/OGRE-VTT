...
import { type Hex, key, neighbors, toOffset } from '../src/engine/hex.js';
import {
  type GameMap,
  allHexes,
  inBounds,
...
import { buildGevMap, buildOgreMap } from '../src/engine/mapdata.js';
import { type Mobility, entryCost, sideCrossing } from '../src/engine/terrain.js';
import { CUSTOM, MAP_LIMITS, customMap } from '../src/scenarios/index.js';
