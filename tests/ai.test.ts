...
import { type GameState, activePlayer, setupActor } from '../src/engine/types.js';
import { overrunActor } from '../src/engine/overrun.js';
import { neighbors } from '../src/engine/hex.js';
import { inBounds, terrainAt } from '../src/engine/map.js';
import { aiPlan, decisionKey } from '../src/ai/player.js';
import { ASSAULT, SCENARIOS, scenarioById } from '../src/scenarios/index.js';
