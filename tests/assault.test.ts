...
import { toOffset } from '../src/engine/hex.js';
import { movementAllowance, makeOgre } from '../src/engine/state.js';
import { isOgre, onBoard } from '../src/engine/types.js';
import {
  ASSAULT,
  ASSAULT_ASTEROID,
  HALF_OGRE_MAP,
  applyOgreRecord,
} from '../src/scenarios/assault.js';
import { ogreRecordOf, readBattleResult } from '../src/campaign/result.js';
